    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (header != null && header.startsWith("Bearer ")) {
            ...
            if (jwtTokenProvider.validarToken(token)) {
                Long userId = jwtTokenProvider.extraerIdUsuario(token);
                ...
                // El principal es el id del usuario — los controladores lo extraen
                // directamente del SecurityContext sin necesidad de recibirlo en el body
